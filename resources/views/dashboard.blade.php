...
@section('content')
    <?php
    $todos = [(object) ['id' => 1, 'description' => 'Buy groceries', 'completed' => false], (object) ['id' => 2, 'description' => 'Read a book', 'completed' => true], (object) ['id' => 3, 'description' => 'Go for a run', 'completed' => false], (object) ['id' => 4, 'description' => 'Call mom', 'completed' => true], (object) ['id' => 5, 'description' => 'Finish project report', 'completed' => false]];
    ?>
    <div class="py-12">
