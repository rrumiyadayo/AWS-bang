...
@section('content')
    ...
    <script>
        ...
        const closeAiAssistantButton = document.getElementById('close-ai-assistant');

        aiAssistantButton.addEventListener('click', () => {
            aiAssistantSidebar.classList.remove('translate-x-full');
        });

        closeAiAssistantButton.addEventListener('click', () => {
            aiAssistantSidebar.classList.add('translate-x-full');
        });
    </script>
